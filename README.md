...
+ [Autopsy(Linux) guide and disk image forensics with openssl decryption of a flag](https://github.com/FidgetCube/CTF_writeups/tree/main/2022-picoCTF/operationOrchid(forensics))
